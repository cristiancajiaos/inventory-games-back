...
public class PlatformController {
  ...
  public List<PlatformDTO> getAllPlatformsOrderByPlatformNameLike(@PathVariable String name) {
    return platformService.getAllPlatformsOrderByPlatformNameLike(name);
  }
